...
if (isset($_REQUEST['Rm']) || isset($_REQUEST['Nome']) || isset($_REQUEST['Data']) || isset($_REQUEST['Email']) || isset($_REQUEST['Senha'])){
...
//mysqli_close($con);
			 ...
			 echo '<script>alert("FALHA A REALIZAR CADASTRO!") </script>';
